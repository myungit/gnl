...
/*   Updated: 2019/12/16 23:06:17 by mpark-ki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	printf("line:%s\n", line);
	free(line);
	printf("result: %d", get_next_line(0, &line));
	printf("line:%s\n", line);
	free(line);
	printf("result: %d", get_next_line(fd, &line));
	printf("line:%s\n", line);
	...
	printf("line:%s\n", line);
	free(line);
	printf("result: %d", get_next_line(1, &line));
	printf("line:%s\n", line);
	free(line);
	printf("result: %d", get_next_line(3, &line));
	printf("line:%s\n", line);
	free(line);
}
